      ...
      <table className="w-full text-left border-collapse min-w-max">
        <thead className="sticky top-0">
          <tr className="bg-indigo-50 border-b border-gray-200">
            <th className="p-4 font-bold text-indigo-900 border-r border-gray-200 sticky left-0 bg-indigo-50 z-10 min-w-[150px]">
              Item
            </th>
        ...
        <tbody>
          {activeKeys.map((itemName) => {
            ...
            return (
              ...
              >
                <td className="p-4 font-bold text-gray-800 border-r border-gray-200 sticky left-0 bg-white z-10 min-w-[150px]">
                  {itemName}
                </td>
                {Object.keys(data).map((month) => {
